...
const Banner = ({
  ...
  return (
    <>
      <section
        className={`relative lg:min-h-[300px] bg-cover bg-center pt-[93px] ${isBlogPage ? 'before-bg' : 'bg-gray-100'}`}
      ...
      >
        <div className="xl:container lg:container-fluid mx-auto flex flex-col lg:flex-row items-stretch justify-between gap-6 sm:gap-6 md:gap-6">
          <div className="flex flex-col gap-5 md:flex-col lg:flex-row xl:flex-row items-end w-full mx-auto md:px-0 sm:px-6 lg:px-4 sm:gap-[30px]">
            ...
            >
              <h2 className="text-[24px] sm:text-[30px] md:text-[36px] lg:text-[45px] tracking-[0] font-semibold text-[var(--text-primary)] lg:leading-[53px] md:leading-[30px] mb-[20px] lg:mb-[30px]">
                {title}
              </h2>
