...
export default function Login() {
  ...
  return (
    <div className="w-full flex flex-col justify-center h-full text-center md:text-left my-8 md:my-[30px] lg:my-[100px]">
      <h2 className="text-[20px] sm:text-[22px] md:text-[26px] lg:text-[30px] font-medium tracking-[0] text-[var(--text-primary)] text-center">
        Login Now
      </h2>
      <div className="w-20 h-1 bg-[var(--btn-primary-bg)] rounded-full mt-[16px] mb-4 mx-auto" />
      ...
      <div className="border border-[#D4DEEB] rounded-xl h-[100%] bg-[#ffff]">
        ...
        <form
          ...
          className="space-y-6 w-full px-[30px] py-[30px] md:pt-[0] sm:pt-[30px]"
        >
          {/* Email Field */}
          <div className="mb-[30px] relative">
            <label className="block text-[14px] font-bold text-[var(--text-primary)] absolute bg-white px-[2px] top-[-10px] left-[20px] z-50">
              Email
            </label>
            <div className="relative rounded-[5px]">
              <img
              ...
              <input
                ...
                type="email"
                placeholder="Enter Your Email"
                className={`w-full pl-10 py-[20px] text-[12px] font-light text-[var(--text-secondary)] border rounded-md focus:outline-none ${
                  emailValue && errors.email ? 'border-[var(--text-danger)]' : 'border-gray-300'
                }`}
              />
            </div>
            {emailValue && errors.email && (
              <p className="text-[var(--text-danger)] text-xs mt-1">{errors.email.message}</p>
            )}
          </div>
          ...
          <div className="mb-[30px] relative">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Enter Your Password"
                className={`w-full pl-10 py-[20px] text-[12px] font-light text-[var(--text-secondary)] border rounded-md focus:outline-none ${
                  passwordValue && errors.password ? 'border-[var(--text-danger)]' : 'border-gray-300'
                }`}
              />
            </div>
            {passwordValue && errors.password && (
              <p className="text-[var(--text-danger)] text-xs mt-1">{errors.password.message}</p>
            )}
          </div>
          ...
          <div className="flex flex-col-reverse sm:flex-row sm:items-center sm:justify-between text-sm gap-[20px] sm:gap-0 mb-[30px]">
            <label className="flex items-center gap-[8px] cursor-pointer">
              <div className="relative">
                <input type="checkbox" className="sr-only peer" />
                <div className="w-11 h-6 rounded-full bg-[#F2F2F2] peer-checked:bg-[var(--btn-primary-bg)] transition-all duration-300" />
                <div className="absolute left-1 top-1 w-4 h-4 rounded-full bg-white shadow-md transition-all duration-300 peer-checked:translate-x-5" />
              </div>
              <span className="text-[12px] font-normal text-[var(--text-secondary)]">Remember me</span>
            </label>
            <NavLink
              to="/forgot-password"
          ...
          <div className="mt-[40px]">
            <CustomButton
              ...
              onClick={() => handleNavigate('/login')}
              variant="outline"
              className="w-full text-[14px] lg:text-[18px] px-4 sm:px-6 py-btn-y cursor-pointer shadow-btn hover:!text-[var(--text-primary)]"
