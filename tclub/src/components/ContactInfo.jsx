...
const ContactInfo = () => {
  return (
    <div className="p-[30px] bg-[var(--badge-bg)] rounded-lg md:!mb-[40px] mt-[40px] md:mt-0">
      <div className="mb-6">
        <h3
        ...
        <p className="text-[var(--text-secondary)] font-normal text-[16px] leading-[24px] w-full max-w-[566px]">
          It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
        </p>
      </div>
            ...
            <div className="flex-1 w-full">
              <p
                className="text-[16px] leading-[22px] 
                    ...
                    md:text-[20px] md:leading-[26px]
                    lg:text-[25px] lg:leading-[27px]
                    font-bold text-[var(--text-primary)] tracking-[0] mb-2"
              >
                {item.title}
              </p>
              <span className="text-[var(--text-secondary)] font-normal text-[18px] leading-[27px] tracking-[0] break-words block">
                {item.value}
              </span>
            </div>
          </li>
