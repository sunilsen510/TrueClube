...
const NewsBlogs = () => {
  return (
    <div className="w-full max-w-5xl flex flex-col justify-center items-center text-center lg:my-[100px] sm:my-0">
      ...
      <div className="w-20 h-1 bg-[var(--btn-primary-bg)] rounded-full tracking-[0] mt-[16px] mb-4 mx-auto" />
      ...
      <div className="w-full flex flex-wrap gap-6 justify-center h-full md:mb-[40px]">
        {blogData.slice(0, 3).map((blog) => (
          <div
            key={blog.id}
            className="border border-[var(--img-border-color)] py-[20px] pl-[15px] rounded-xl bg-white text-left flex xl:flex-row lg:flex-col flex-col md:flex-row gap-3 sm:gap-4 w-full items-start lg:items-center sm:items-center justify-between"
          >
            <div className="flex flex-col xxl:flex-col lg:flex-col sm:!pr-[15px] pr-[15px] gap-3 sm:gap-4 w-full flex-1 items-start sm:items-center md:!flex-row md:gap-[15px] lg:gap-[15px] md:items-center">
              <img
                src={blog.image}
              ...
              <div className="sm:mt-[15px] lg:mt-0">
                ...
                {blog.id === 1 ? (
                  <>
                    ...
                    <div className="flex items-center gap-[5px] text-sm text-[var(--text-primary)]">
                      <img
                        src={calenderImg}
                        alt="calendar"
                        className="w-[18px] h-[18px]"
                      />
                      <span className="font-semibold text-[12px] text-[var(--text-primary)]">{blog.date}</span>
                    </div>
                  </>
                ) : (
                  <div className="flex flex-col xl:flex-col 2xl:flex-row gap-[20px] lg:gap-[14px]">
                    <div className="flex items-center gap-[5px] text-sm text-[var(--text-primary)]">
                      <img
                        ...
                        className="w-[18px] h-[18px]"
                      />
                      <span className="text-[var(--text-primary)] text-[12px] font-semibold">Admin</span>
                    </div>
                    <div className="flex items-center gap-[5px] text-sm text-[var(--text-primary)]">
                      <img
                        src={calenderImg}
            ...
            <div className="flex flex-col justify-center items-center flex-none md:self-stretch gap-2 !pr-[20px] md:!w-100%">
              {blog.id === 1 ? (
                ...
                <CustomButton
                  ...
                  to="/"
                  variant="primary"
                  className="w-auto lg:w-[100%] md:w-auto sm:w-[100%] !py-[20px] !px-[22px] !text-[14px] !font-semibold hover:shadow-[var(--btn-shadow)]"
                />
              )}
            </div>
          </div>
