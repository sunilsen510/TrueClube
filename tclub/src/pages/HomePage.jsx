...
const HomePage = () => {
  return (
    <>
      <HeroBanner />
      <section className="lg:py-0 md:py-4">
        <div className="xl:container lg:container-fluid max-w-7xl px-0 mx-auto flex flex-col lg:flex-row items-start gap-[var(--gap-desktop)] xl:gap-[var(--gap-desktop)] lg:gap-[var(--gap-tablet)] md:gap-[var(--gap-tablet)] relative md:flex-col">
          
          {/* Left: Login */}
          <div className="w-full lg:w-1/2 md:w-full px-[var(--container-padding)]">
            <Login />
          </div>

          {/* Vertical Divider */}
          <div className="hidden xl:block absolute top-0 bottom-0 left-1/2 w-px bg-divider transform -translate-x-1/2"></div>
